...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <h2>Pel&iacute;culas&nbsp;
          <img id='img_add' class='img_button' src='images/plus-square-fill.svg' alt='' width='28' height='28' title='Agregar Registro' onclick='editBean("movies")'>
